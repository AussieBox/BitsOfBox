...
public class ShimmerJarItem extends TrinketItem {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> list, TooltipType type) {
        ...
        list.add(2, Text.translatable("item.ccosmo.shimmer_jar.tooltip.1").withColor(0xFFAAAAAA));
        list.add(3, Text.translatable("item.ccosmo.shimmer_jar.tooltip.2").withColor(0xFFAAAAAA));
