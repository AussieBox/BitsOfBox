...
public interface BOBConstants {
    ...
    static Map<Item, Double[]> fluidityAttackDamages() {
        fluidityAttackDamages.put(ModItems.WOODEN_FLUIDITY, new Double[]{7.0, 7.0, 2.0});
        fluidityAttackDamages.put(ModItems.STONE_FLUIDITY, new Double[]{7.5, 8.0, 3.0});
        fluidityAttackDamages.put(ModItems.COPPER_FLUIDITY, new Double[]{8.0, 8.5, 3.5});
        fluidityAttackDamages.put(ModItems.GOLD_FLUIDITY, new Double[]{7.5, 7.0, 2.0});
        fluidityAttackDamages.put(ModItems.IRON_FLUIDITY, new Double[]{9.0, 9.0, 4.0});
        fluidityAttackDamages.put(ModItems.DIAMOND_FLUIDITY, new Double[]{10.0, 9.0, 5.0});
        fluidityAttackDamages.put(ModItems.NETHERITE_FLUIDITY, new Double[]{11.0, 10.0, 6.0});
    ...
    static Map<Item, Double[]> fluidityAttackSpeeds() {
        ...
        fluidityAttackSpeeds.put(ModItems.GOLD_FLUIDITY, new Double[]{-2.8, -3.0, -2.8});
