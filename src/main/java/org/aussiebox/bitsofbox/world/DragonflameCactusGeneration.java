package org.aussiebox.bitsofbox.world;
...
public class DragonflameCactusGeneration {
    public static void generateCacti() {
        RegistryKey<PlacedFeature> key = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(BOB.MOD_ID, "place_dragonflame_cactus"));
