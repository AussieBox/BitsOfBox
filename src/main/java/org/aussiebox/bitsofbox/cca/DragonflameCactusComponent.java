...
public class DragonflameCactusComponent implements AutoSyncedComponent, ServerTickingComponent {
    public static final ComponentKey<DragonflameCactusComponent> KEY = ComponentRegistry.getOrCreate(BOB.id("dragonflame_cactus_component"), DragonflameCactusComponent.class);
