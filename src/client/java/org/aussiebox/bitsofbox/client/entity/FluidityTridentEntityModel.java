...
public class FluidityTridentEntityModel extends EntityModel<FluidityTridentEntity> {
    public static final Identifier TEXTURE = BOB.id("textures/item/fluidity/trident_hand.png");
    private final ModelPart root;

    public FluidityTridentEntityModel(ModelPart root) {
    ...
    @Override
    public void setAngles(FluidityTridentEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
